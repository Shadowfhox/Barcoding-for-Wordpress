 ...
 * @see WP_Widget
 */
class partners_nav_menu extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'partners_nav_menu', __('Partners Custom Menu'), $widget_ops );
	}
...
add_action( 'widgets_init', 'partners_nav_menu_init' );

// Register Widget
function partners_nav_menu_init() {
	register_widget( 'partners_nav_menu' );
}
