...
class home_slide extends WP_Widget {
...
------------------------------------------------ */
	 ...
	 parent::__construct( 'home_slide',   __( 'Home Page Slide', 'text_domain' ),  array( 'description' => __( 'Display Maps and location description for the About us Page', 'text_domain' ), ) 
   );
	}
...
add_action( 'widgets_init', 'home_slide_init' );

// Register Widget
function home_slide_init() {
