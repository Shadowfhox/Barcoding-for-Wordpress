<?php class custom_buttom extends WP_Widget {
    ...
    parent::__construct( 'custom_buttom',   __( 'Custom Button', 'text_domain' ),  array( 'description' => __( 'Displays a single post with an image', 'text_domain' ), ) 
   );
