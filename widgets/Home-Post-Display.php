<?php
/* Based on plugin by Shashidhar Kumar http://www.shashidharkumar.com/
...
function widget ($args,$instance) {
  ...
  $out = '<ul class="swift-slide business-slide">';
  ...
  $out .= '<li class="business"><span class="business__label">'.$post->post_title.'</span>
              <div class="business__details">
                    <h2>'.$post->post_title.'</h2>
                    <h3>Header Lorem Ipsum Dolor</h3>
                    <p>'.$exrt.'
                    </p>
                    <div class="h5">Interested in '.$post->post_title.'?&nbsp;<a href="'.get_permalink($post->ID).'">Learn More.</a></div>
              </div>
            </li>'  ;
  }
